//#include "Pandora/GArContent/include/GArObjects/Helix.h"
...

{
    ...
    pandora::StatusCode Helix::GetPointInX(const float xPlane, const pandora::CartesianVector &referencePoint, pandora::CartesianVector &intersectionPoint, float &genericTime) const
    {
    ...
    pandora::StatusCode Helix::GetPointOnCircle(const float radius, const pandora::CartesianVector &referencePoint, pandora::CartesianVector &intersectionPoint, float &genericTime) const
    {
    ...
    pandora::StatusCode Helix::GetDistanceToHelix(const gar_content::Helix *const pHelix, pandora::CartesianVector &positionOfClosestApproach, pandora::CartesianVector &v0momentum, float &helixDistance) const
