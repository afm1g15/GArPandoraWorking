...
namespace gar {
    namespace gar_pandora {
        ...
        pandora::StatusCode PandoraInterface::RegisterUserComponents() const
        {
            ...
            PANDORA_RETURN_RESULT_IF(pandora::STATUS_CODE_SUCCESS, !=, LCContent::RegisterNonLinearityEnergyCorrection(*m_pPandora, "NonLinearity", pandora::HADRONIC, m_settings.m_inputEnergyCorrectionPoints, m_settings.m_outputEnergyCorrectionPoints));
